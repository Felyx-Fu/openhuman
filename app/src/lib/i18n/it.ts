...
const messages: TranslationMap = {
  ...
  'walkthrough.progress.current': 'attuale',
  'walkthrough.step.start': 'Inizia configurazione',
  'walkthrough.desc.start': 'Rivedi la guida e inizia a collegare il tuo assistente',
};
