...
const messages: TranslationMap = {
  ...
  'onboarding.welcome.heroSubtitle': 'OpenHuman은 도구를 연결하고, 작업을 자동화하며, 결과를 제공합니다 — 모두 데스크톱에서.',
  ...
  'bootCheck.heroWebDesc': '시작하려면 런타임에 연결하세요. 아래에 URL과 인증 토큰을 입력하거나 데스크톱 앱을 받으세요.',
  ...
  'onboarding.welcome.capability1Desc': '비서가 이메일을 처리하고, 회의를 예약하고, 모든 도구에서 프로젝트를 추적하도록 하세요.',
  'onboarding.welcome.capability2Title': '모든 것 자동화',
  'onboarding.welcome.capability2Desc': '자동으로 실행되는 루틴을 설정하세요 — 아침 브리핑, 일일 요약, 반복 작업.',
  'onboarding.welcome.capability3Title': '개인정보 보호',
  'onboarding.welcome.capability3Desc': '데이터는 기기에 보관됩니다. 무엇이 나가고 어디로 가는지 제어할 수 있습니다.',
  'walkthrough.steps.welcome.title': 'OpenHuman에 오신 것을 환영합니다',
  'walkthrough.steps.welcome.content': '새로운 AI 비서의 빠른 투어를 진행해 보겠습니다. 몇 단계만으로 핵심 사항을 다룰 것입니다.',
  'walkthrough.steps.commandCenter.title': '커맨드 센터',
  'walkthrough.steps.commandCenter.content': '이곳은 홈 베이스입니다 — 현재 상황과 주의가 필요한 항목에 대한 빠른 개요를 제공합니다.',
  'walkthrough.steps.startChat.title': '대화 시작하기',
  'walkthrough.steps.startChat.content': '언제든지 여기를 탭하여 AI와 채팅을 시작하세요. 질문하고, 아이디어를 브레인스토밍하고, 일을 처리하세요.',
  'walkthrough.steps.aiAtWork.title': '작업 중인 AI',
  'walkthrough.steps.aiAtWork.content': '이곳에서 대화가 이루어집니다. 비서가 웹을 검색하고, 도구를 실행하며, 채팅 간 컨텍스트를 기억할 수 있습니다.',
  'walkthrough.steps.connectTools.title': '도구로 강화하기',
  'walkthrough.steps.connectTools.content': 'Gmail, Slack, WhatsApp 등을 연결하세요. 각 연결은 비서에게 새로운 능력을 부여합니다.',
  'walkthrough.steps.chatAnywhere.title': '어디서나 채팅',
  'walkthrough.steps.chatAnywhere.content': 'WhatsApp, Telegram, Slack, Discord — 메시징 앱을 연결하여 비서가 어디서든 연락할 수 있도록 하세요.',
  'walkthrough.steps.aiBrain.title': 'AI의 두뇌',
  'walkthrough.steps.aiBrain.content': '이곳은 비서가 배우고 기억하는 곳입니다. 더 많이 사용할수록 더 똑똑해집니다 — 기억, 컨텍스트, 지능이 모두 여기에 있습니다.',
  'walkthrough.steps.customize.title': '나만의 것으로 만들기',
  'walkthrough.steps.customize.content': '환경설정, 개인정보, 알림 — 모든 것이 여기에 있습니다. 설정에서 언제든지 이 투어를 다시 시작할 수 있습니다.',
  'walkthrough.steps.quickAccess.title': '빠른 접근',
  'walkthrough.steps.quickAccess.content': '이 탭들은 바로 가기입니다 — 채팅, 스킬, 인텔리전스가 항상 한 번의 탭 거리에 있습니다.',
  'walkthrough.steps.stayInformed.title': '정보 유지하기',
  'walkthrough.steps.stayInformed.content': '알림과 자동화가 여기에 있습니다 — 브리핑, 알림 및 백그라운드 활동.',
  'walkthrough.steps.allSet.title': '모든 준비가 완료되었습니다!',
  'walkthrough.steps.allSet.content': '비서가 환영 메시지를 남겼습니다 — 이곳은 채팅하고, 질문하고, 브레인스토밍하는 공간입니다. 즐기세요!',
  ...
  'walkthrough.connect.description': '이미 사용 중인 도구를 연결하세요. 각 연결은 비서에게 새로운 능력을 부여합니다.',
  ...
  'walkthrough.done.description': '비서가 도움을 줄 준비가 되었습니다. 연결이 설정되고 자동화가 구성되었습니다.',
